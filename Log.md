...
# V1.13.8-Branch-From-V1.13.7-Room-Control

## Nguồn nhánh
- Tạo trực tiếp từ `PES Arena V1.13.7`.
- Tên hiển thị phiên bản: `V1.13.8-Branch-From-V1.13.7-Room-Control`.

## Thay đổi
- Thêm nút **Trở Lại Phòng Đấu** trong khu Điều khiển/Tổng quan khi có phòng đang hoạt động.
- Ép chủ phòng và khách quay lại phòng khi phòng đã đủ 2 người và thủ tục trận chưa hoàn tất.
- Thêm lịch sử đối đầu giữa hai người trong phần Điều khiển phòng, chỉ tính các trận xác nhận từ thời điểm mở phòng hiện tại.
- Bỏ ghi chú kỹ thuật `Smart Tier Random / Power score / Host XP` khỏi trận được tạo tự động.
- Phòng chưa bắt đầu tự hủy sau 30 phút không hoạt động, không trừ RP.
- Trận đã quay đội nhưng chủ chưa nhập tỷ số sau 60 phút: hủy phòng và trừ chủ ngẫu nhiên 22–25 RP.
- Trận đang chờ khách xác nhận sau 60 phút: hủy phòng và trừ khách ngẫu nhiên 22–25 RP.
- Thoát/bỏ cuộc sau khi đã quay đội cũng dùng mức phạt ngẫu nhiên 22–25 RP.

## Kiểm tra
- `python -m py_compile app.py`: đạt.
- `python test_rp_engine.py`: đạt.
